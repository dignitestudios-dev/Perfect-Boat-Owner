...
const GlobalLayout = ({ page }) => {
  ...
  return (
    <div className="w-full h-screen overflow-y-hidden flex justify-start items-start">
      {path === "/managers/assign-boats-access-rights" ||
      path === "/boat/assign-access-rights" ? (
        <div
          className={`fixed lg:static top-0 left-0 w-[280px] bg-[#001229] py-4 px-6 flex flex-col justify-start items-start transition-transform duration-300 lg:translate-x-0 z-40 h-screen overflow-y-auto`}
        >
