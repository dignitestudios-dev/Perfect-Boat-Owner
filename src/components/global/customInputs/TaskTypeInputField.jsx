...
const TaskTypeInputField = ({toggleTaskTypeDropdown,selectedTaskType,isTaskTypeDropdownOpen, isEdit, setInputError,
    taskTypeDropdownRef,handleTaskTypeSelection,customInput,setCustomTypeText,customTypeText}) => {
  return (
