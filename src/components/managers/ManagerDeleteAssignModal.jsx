...
const ManagerDeleteAssignModal = ({managers, managerId="", setIsOpen, SetPassSelectedManager, selectedManager, setSelectedManager}) => {

    const [searchTerm, setSearchTerm] = useState("");
    const jobTitleRef = useRef(null);
    const locationRef = useRef(null);

    const filteredData = managers?.filter( (item) => item?.name?.toLowerCase()?.includes(searchTerm?.toLowerCase()) && item._id !== managerId);
