...
const BoatAccessTable = ({boatsData, setIsManagerModalOpen, togglejobFilter,
     jobRef, jobFilter, toggleLocationFilter, locationRef, locationFilter}) => {
  return (
    <div className="w-full h-auto flex flex-col gap-4 p-4 lg:p-6 rounded-[18px] bg-[#001229]">
          ...
          <div className="w-full h-auto flex justify-between items-center">
            {boatsData?.boatAccess?.length === 0 ? <div></div> :
