...
const PrivacyPolicy = () => {
  return (
    <div className="h-full overflow-y-auto w-full p-2 lg:p-6 flex flex-col gap-6 justify-start items-start">
      <div className="w-full xl:h-[87vh] relative  flex flex-col gap-4 p-4 lg:p-6 rounded-[16px] bg-[#001229]">
      <span className="w-full h-[272px] bg-gradient-to-t from-[#001229]/[1] to-[#001229]/[0] absolute bottom-0 rounded-b-[16px] left-0"></span>
      <div className="w-full h-[100%] overflow-y-auto flex flex-col gap-4 ">
